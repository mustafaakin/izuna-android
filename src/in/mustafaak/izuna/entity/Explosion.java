...
public class Explosion extends AnimatedSprite {
	public Explosion(float pX, float pY, boolean isBigExplosion){
		super(pX, pY, isBigExplosion ? TextureProvider.getInstance().getExplosionBig() : TextureProvider.getInstance().getExplosionSmall(), TextureProvider.getInstance().getVertexBufferObjectManager());
