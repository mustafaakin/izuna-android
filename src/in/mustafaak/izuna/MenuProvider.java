...
public class MenuProvider {
	...
	public static MenuScene getPauseMenu(final Engine engine, final MainActivity owner) {
		...
		final SpriteMenuItem resetMenuItem = new SpriteMenuItem(MENU_RESUME, texProvider.gePauseResumeButtonTextureRegion(),
	...
	public static Menu getScores() {
		...
		Sprite back = new Sprite(x,y, tex.getTexPackRegMainMenu().get(SpriteSheet.MENU_BACK_ID), tex.getVertexBufferObjectManager()){
			long lastClick = 0;
